...
### 1. Dynamic UI: Loading spinner implementing a FluentWait
- I created a HTML file [resources/LoadingSpinnerWebPage.html](./resources/LoadingSpinnerWebPage.html) with a loading spinner that will disappear after 3 seconds, then a text box will show.
